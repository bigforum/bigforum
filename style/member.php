...
if($_GET["do"] == "groups")
{
  ...
  echo "<table width=100%><tr class=normal><td style=font-weight:bold width=70%><font color=snow>Administratoren</font></td><td><font color=snow>Kontakt</font></td></tr>";
  ...
  echo "</table>";
  echo "<table width=100%><tr class=normal><td style=font-weight:bold width=70%><font color=snow>Moderatoren</font></td><td><font color=snow>Kontakt</font></td></tr>";
...
?>
<table width="100%">
<tr background="images/dark_table.png" color=snow>
<td color=snow>
