...
$sons = array("?do=settings|Foren-Einstellungen","?do=settings_admincp|Kontrollzentrum-Einstellungen","?do=raenge|Ränge-Einstellungen","?do=mods|Mods/Addons Verwaltung","?do=new_warn|Verwarnungsgründe","?do=adser|Adserver");
$for = array("?do=new_foren|Neues Forum","?do=ver_foren|Verwalte Foren");
$user = array("?do=ver_user|Benutzer suchen","?do=sper_user|Gesperrte","?do=inaktiv|Inaktive Benutzer","?do=recht| Administratoren-Rechte","?do=zuruck|Rechte zurücksetzen","?do=not_use|Benutzernamen / eMail-Adressen verbieten","?do=rundbrief| Rundbrief schreiben");
$start = array("admin.php|Start","?do=ver_check|Version-Check","?do=settings|Foren-Einstellungen","?do=look_logs|Log-Einträge","?do=new_foren|Neues Forum erstellen","?do=ver_user|Benutzer verwalten");
...
switch ($do) {
  ...
  Um Änderungen hier vorzunehmen, benutze bitte erst die obere Navigation (Oberbegriff) und dann die Navigation auf der linken Seite (konkrete Änderung).
  ...
  echo "</form></td></tr></table><br><br>";
	...
	<b>Darf Foreneinstellungen ändern:</b> Darf alle möglichen Foreneinstellungen so wie den Foren-Titel, die Foren-Beschreibung usw. verändern. Desweiteren darf auch die Administratoren-Notiz ab diesem Level verändert werden.<br><br>
