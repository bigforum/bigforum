...
$foren_data = mysql_query("SELECT * FROM kate");
  echo "<table color=snow width=100% class=dark><tr><td width=70%><font color=snow>Name</font></td><td><font color=snow>Letzter Beitrag</font></td><td width=5%><font color=snow>Themen</font></td><td width=5%><font color=snow>Beiträge</font></td></tr></table>";
