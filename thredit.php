...
if($_GET["aktion"] != "")
{
  ...
  {
    mysql_query("UPDATE thema SET text = '$_POST[feld]', edit_from = '". USER ."', last_edit = '$time' WHERE id LIKE '$_GET[id]'") or die(mysql_fehler(mysql_error(), __LINE__, $_SERVER["PHP_SELF"]));
  }
