  ...
  case "pro_user":
    ...
    admin_recht("5");
	 ...
	 if($uds->id == "")
	 {
	   ...
	   <tr><td><b>Darf HTML in Beiträgen benutzen</b></td><td><input type=radio name=htmlcan value=1 $eeditf>Ja <input type=radio name=htmlcan value=2 $eeditr> Nein</td></tr>
	   <tr><td> &nbsp; </td><td> &nbsp; </td></tr>
	   <tr><td>	
